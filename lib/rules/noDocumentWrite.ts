...
export default {
  ...
  const useTypeInfo =
    ...
    function isDomDocumentObject(
      ...
      if (useTypeInfo && parserServices && parserServices.program &&
          parserServices.esTreeNodeToTSNodeMap) {
      ...
      if (
        ...
        expressionNode.type === TSESTree.AST_NODE_TYPES.MemberExpression &&
        expressionNode.property.type === TSESTree.AST_NODE_TYPES.Identifier &&
        expressionNode.property.name === "document" &&
        expressionNode.object.type === TSESTree.AST_NODE_TYPES.Identifier &&
